...
export const authApi = {
  register: (body: { username: string; email: string; password: string; firstName?: string; lastName?: string; country?: string }) =>
...
export const usersApi = {
  updateProfile: (data: { firstName?: string; lastName?: string; bio?: string; phone?: string; country?: string }) =>
...
export const walletApi = {
  ...
  getTransactions: (page = 1, limit = 20) =>
    apiFetch<{
      data: Array<{ id: string; type: string; direction: string; amountKobo: number; amountNaira: number; balanceAfterNaira: number | null; status: string; reference: string; description: string; createdAt: string }>;
...
export const marketplaceApi = {
  listProducts: (category?: string) =>
    apiFetch<{ data: Array<{ id: string; title: string; description: string | null; category: string; priceNaira: number; coverUrl: string | null; contentUrl: string | null; salesCount: number; seller: string | null; sellerName: string | null; createdAt: string }> }>(
      `/marketplace/products${category ? `?category=${category}` : ''}`
    ),
  getProduct: (id: string) =>
    apiFetch<{ data: { id: string; title: string; description: string | null; category: string; priceNaira: number; coverUrl: string | null; contentUrl: string | null; salesCount: number; seller: string | null; sellerName: string | null; createdAt: string } }>(
  ...
  myPurchases: () =>
    apiFetch<{ data: Array<{ purchaseId: string; productId: string; title: string; description: string | null; category: string; contentUrl: string | null; seller: string; priceNaira: number; purchasedAt: string }> }>(
  ...
  pendingProducts: () =>
    apiFetch<{ data: Array<{ id: string; title: string; description: string | null; category: string; priceNaira: number; contentUrl: string | null; seller: string | null; sellerName: string | null }> }>(
      '/marketplace/pending',
    ),
  pendingCount: () =>
...
export const academyApi = {
  listCourses: () =>
    apiFetch<{ data: Array<{ id: string; title: string; description: string | null; category: string; level: string; priceNaira: number; isFree: boolean; coverUrl: string | null; contentUrl: string | null; lessonCount: number; createdAt: string }> }>(
      '/academy/courses',
    ),
  getCourse: (id: string) =>
    apiFetch<{ data: { id: string; title: string; description: string | null; category: string; level: string; priceNaira: number; isFree: boolean; coverUrl: string | null; contentUrl: string | null; createdAt: string; lessons: Array<{ id: string; courseId: string; title: string; videoUrl: string | null; content: string | null; position: number }> } }>(
      `/academy/courses/${id}`,
    ),
  createCourse: (data: { title: string; description?: string; category?: string; level?: string; price?: number; coverUrl?: string; contentUrl?: string }) =>
    apiFetch<{ data: { id: string; title: string } }>(
      '/academy/courses',
      { method: 'POST', body: JSON.stringify(data) },
    ),
  updateCourse: (id: string, data: { title?: string; description?: string; category?: string; level?: string; price?: number; coverUrl?: string; contentUrl?: string }) =>
    apiFetch<{ data: { id: string; title: string } }>(
      `/academy/courses/${id}`,
